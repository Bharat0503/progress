...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Image, FlatList, RefreshControl, ActivityIndicator, Share } from 'react-native'
...
const FeaturedContentListingWeb: React.FC = (props) => {
        ...
        <View style={[styles.container, { width: getWidth(50), padding: config.isWeb ? getWidth(1) : 0 }]}>
            {isLoading
                ...
                <FlatList
                    ...
                    contentContainerStyle={[styles.listContainer, { width: getWidth(50) }]}
                />
            }
...
export default FeaturedContentListingWeb
